...
#define BTN1_GPIO    GPIO_NUM_27
#define BTN2_GPIO    GPIO_NUM_14
#define BTN3_GPIO    GPIO_NUM_12
#define BTN4_GPIO    GPIO_NUM_13
...
static void initIO(void)
{
    ...
    gpio_pullup_en(BTN3_GPIO);
    gpio_set_direction(BTN4_GPIO, GPIO_MODE_INPUT);
    gpio_pullup_en(BTN4_GPIO);
}
...
eButtonState_t checkButtons(eButtonId_t *buttonNumber)
{
    ...
    if (gpio_get_level(BTN1_GPIO) == 1 && gpio_get_level(BTN2_GPIO) == 1 && gpio_get_level(BTN3_GPIO) == 1 && gpio_get_level(BTN4_GPIO) == 1 )
    {
        updateLeds(0, 0);
